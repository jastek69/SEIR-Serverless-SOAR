# SOAR Report - unused-token-eventbridge-scheduler-1784529815 - 2026-07-20_06-43-35_UTC

- Trigger: eventbridge-scheduler
- Generated: 2026-07-20T06:43:35Z
...
The authentication and token issuance are confirmed facts. The detector's inability to examine any records means the unused-token condition described in the event header **may be real but is invisible to the current detection pipeline**. This is an **implementation gap**, not a confirmed
