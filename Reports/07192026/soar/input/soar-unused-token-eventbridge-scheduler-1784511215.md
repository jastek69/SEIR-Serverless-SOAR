# SOAR Report - unused-token-eventbridge-scheduler-1784511215 - 2026-07-20_01-33-35_UTC

- Trigger: eventbridge-scheduler
- Generated: 2026-07-20T01:33:35Z
...
This distinction is essential. The event does **not** confirm that:
- A malicious actor authenticated and abandoned a token
- A token was issued and deliberately left unused to probe session behavior
- Any Cognito JWT is currently in a suspicious state

**What is confirmed by the evidence:**
| Field | Value | Interpretation |
|---|---|---|
| `records_examined` | 0 | No records were present or queryable in the token store at scan time |
...
| `trigger_source` | EventBridge Scheduler | Detector invoked on schedule, not by anomaly |
